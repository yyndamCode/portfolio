...
import aboutImage from "@/../public/Group 1000015845(1).png";
        ...
        <main>
            <section className={styles.about}>
                <div className={styles["about__image"]}>
                    <Image src={aboutImage} width="auto" height={572} priority={true} alt="about me"/>
                </div>

                <div className={styles["about__content"]}>
                    <h2 className={styles["about__title"]}>About <strong>Me</strong>
                    </h2>
